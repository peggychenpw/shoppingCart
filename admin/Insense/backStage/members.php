...
<div class="container">
  ...
  <form name="myForm3" method="POST" action="../action/deleteMultipleMember.php">
    <div class="btnDiv d-flex">
      ...
      <button type="button" class="myBtn btn btn btn-outline-success mx-2" onclick="newFunc()" data-toggle="modal" data-target="#newModel" data-whatever="">新增</button>
    </div>
    <div class="tableWrap">
          ...
          ?>
              ...
              <tr class="myTbodyTr" id="myTbodyTr">
                ...
                <td class="border head_features_w pl-1 tbodyTd12 d-flex">
                  ...
                  <button type="button" class="myFeatureBtn btn btn-outline-primary mx-2" onclick="editFunc(this)" data-toggle="modal" data-target="#editModel" data-id="<?php echo $arr[$i]['id']; ?>" data-whatever="<?php echo $arr[$i]['id']; ?>">編輯</button>
