...
<h3>預約更改</h3>
<input class="btn btn-primary" type="button" value="上一頁" onclick="location.href='./bookSearch.php?page=<?php echo $_GET['page']?>'">

<form name="myForm" enctype="multipart/form-data" method="POST" action="../action/bookUpdate.php?page=<?php echo $_GET['page']?>">
    <table class="border">
        <thead>
            <tr>
